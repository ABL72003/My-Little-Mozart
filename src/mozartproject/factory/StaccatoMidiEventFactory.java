...
public class StaccatoMidiEventFactory implements MidiEventFactory {
	 ...
	 * Creates a Staccato note-on MIDI event by delaying the tick by 120 to allow overlapping notes.
	 ...
	 * Creates a Staccato note-off MIDI event by delaying the tick by 120 to allow overlapping notes.
